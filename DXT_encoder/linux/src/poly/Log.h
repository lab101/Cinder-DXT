...
#else
  #if defined(_MSC_VER)
  #  define SX_DEBUG(fmt, ...) { poly_debug(__LINE__, __FUNCSIG__, fmt, ##__VA_ARGS__); } 
  #  define SX_VERBOSE(fmt, ...) { poly_verbose(__LINE__, __FUNCSIG__, fmt, ##__VA_ARGS__); } 
  #  define SX_WARNING(fmt, ...) { poly_warning(__LINE__, __FUNCSIG__, fmt, ##__VA_ARGS__); } 
  #  define SX_ERROR(fmt, ...) { poly_error(__LINE__, __FUNCSIG__, fmt, ##__VA_ARGS__); } 
  #else                                                                             
